...
const BADGES: Record<string, FileBadge> = {
  ...
  js: { label: "JS", className: "bg-[#e8d44d] text-sideBar-background" },
  jsx: { label: "JS", className: "bg-[#e8d44d] text-sideBar-background" },
  json: { label: "{ }", className: "bg-[#e8d44d] text-sideBar-background" },
  ...
  png: { label: "IM", className: "bg-[#3cc060] text-sideBar-background" },
  jpg: { label: "IM", className: "bg-[#3cc060] text-sideBar-background" },
  webp: { label: "IM", className: "bg-[#3cc060] text-sideBar-background" },
};
